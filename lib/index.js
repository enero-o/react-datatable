  ...
  _createClass(ReactDatatable, [{
    ...
    value: function filterData(records) {
      ...
      return records.filter(function (record) {
        var allow = false;
        (0, _each2.default)(_this6.props.columns, function (column, key) {
          if (record[column.key]) {
            allow = (0, _includes2.default)(record[column.key].toString().toLowerCase(), filterValue.toString().toLowerCase()) ? true : allow;
          }
        });
        return allow;
      });
    ...
    value: function sortRecords() {
      ...
      if (this.state.sort) {
        return (0, _orderBy2.default)(this.props.records, function (o) {
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                this.props.loading === true ? _react2.default.createElement(
                  ...
                  rowIndex = (0, _indexOf2.default)(_this8.props.records, record);
                  return _react2.default.createElement(
                    'tr',
